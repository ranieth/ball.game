...
public class CreateWindow extends JFrame {
	...
	/**
	 * Boolean variable to determine win after a button press and interface
	 * repaint.
	 */
	boolean win = false;
	...
	public CreateWindow(String filename) {
		...
		JButton buttonExport = new JButton("Export XML");
	...
	void initInterface() {
		...
		tableModel = new BallGameTableModel(board.getField(), ball.getRow(),
				ball.getColumn());
	 ...
	 * 
	 * @param count
	 *            the count of columns on the game board
	 * @param size
	 *            the wanted size of the columns
	 */
	...
	void setWallsBackground() {
		...
		for (int j = 0; j < table.getColumnCount(); j++) {
			...
			table.getColumnModel().getColumn(j)
					.setCellRenderer(new WallCellRenderer());
	 ...
	 * 
	 * Initalizes the buttons, adds them to the content pane and call the event
	 * handler initalizer functions.
	 * 
	 * @param ball
	 *            the ball of the game board
	 */
	...
	/**
	 * Initalizes the action listener to the button which moves up the ball on
	 * the board.
	 * 
	 * @param ball
	 *            the ball of the game board
	...
	/**
	 * Initalizes the action listener to the button which moves down the ball on
	 * the board.
	 * 
	 * @param ball
	 *            the ball of the game board
	...
	/**
	 * Initalizes the action listener to the button which moves right the ball
	 * on the board.
	 * 
	 * @param ball
	 *            the ball of the game board
	...
	/**
	 * Initalizes the action listener to the button which moves left the ball on
	 * the board.
	 * 
	 * @param ball
	 *            the ball of the game board
	...
	public class WallCellRenderer extends DefaultTableCellRenderer {
		 ...
		 * 
		 * Overrided method which creates the renderer to the table. The
		 * renderer sets all the walls background to black in the table.
		 * 
		 * @param table
		 *            the table object of the interface
		 * @param value
		 *            the value of the actual cell in the table
		 * @param isSelected
		 *            <code>true</code> if the actual cell is selected,
		 *            <code>false</code> otherwise
		 * @param hasFocus
		 *            <code>true</code> if the actual cell is focused,
		 *            <code>false</code> otherwise
		 * @param row
		 *            the row index of the actual cell
		 * @param column
		 *            the column index of the actual cell
		 * 
